                ...
                {isMenuOpen && (
                    <div className="md:hidden bg-white border-t">
                        <div className="px-4 py-4 space-y-3">
                            ...
                            <button onClick={() => scrollToSection('services')} className="block w-full text-left text-gray-700 hover:text-blue-600">Services</button>
                            <button onClick={() => scrollToSection('about')} className="block w-full text-left text-gray-700 hover:text-blue-600">About</button>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            We provide comprehensive electrical and mechanical solutions for residential, commercial, and industrial clients.
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-gray-600 mb-6">
                                With over 15 years of experience, we've built a reputation for excellence in electrical and mechanical services. Our certified technicians are committed to delivering quality workmanship and exceptional customer service.
                            </p>
                        ...
                        <div className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl p-8">
                            <div className="bg-white rounded-lg p-6 shadow-lg">
                                ...
                                <div className="space-y-2 text-gray-700">
                                    ...
                                    <p className="text-blue-600 font-semibold mt-4">24/7 Emergency Response Available</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="contact" className="py-20 bg-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600">Get in touch for a free consultation or emergency service</p>
                    </div>
